  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ margin: 0 }}>
          ...
          <p style={{ margin: 0, fontSize: "14px", color: "#fcd9c5" }}>
            {responderName ?? "An approver"} has responded to your request
          </p>
        </div>
      </div>
      ...
      <div style={{ padding: "24px" }}>
        ...
        >
          Your room request for <strong> room {classroomName}</strong> has been{" "}
          <strong style={{ color: statusColor }}>{status}</strong> by{" "}
          <strong>{responderName ?? "the approver"}</strong>.
        </p>
