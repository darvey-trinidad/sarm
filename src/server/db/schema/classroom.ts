...
import { DEFAULT_FLOOR, FLOORS } from "@/constants/floors";
...
export const classroom = sqliteTable(
  "classroom",
  {
    ...
    floor: text("floor", { enum: FLOORS })
      .$defaultFn(() => DEFAULT_FLOOR)
      .notNull(),
    usability: text("usability", { enum: USABILITY })
      .$defaultFn(() => DEFAULT_USABILITY)
      .notNull(),
  },
  (table) => ({
